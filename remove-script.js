// Remove Songs Management System
class RemoveSongsManager {
                ...
                <div class="card-content">
                    ...
                    <div class="song-meta">
                        <span class="created-date">
                            ...
                            ${this.formatDate(song.createdAt)}
                        </span>
                    </div>
                </div>
            </div>
  ...
  executeDelete() {
    ...
    setTimeout(() => {
      const idsToDelete = this.currentDeletingSong;
      const deletedCount = idsToDelete.length;

      // Remove songs from the array
      this.songs = this.songs.filter((song) => !idsToDelete.includes(song.id));

      // Clear selections
      idsToDelete.forEach((id) => this.selectedSongs.delete(id));
